class TinestCli < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/tinyrack-net/coder/releases/download/v0.7.0/tinest-cli-macos-x64.tar.gz"
      sha256 "052aa0d8df7bf9580cfb90c28d16998fbc41192996f2ac2dd57bee09517fa5ad"
    end
    on_arm do
      url "https://github.com/tinyrack-net/coder/releases/download/v0.7.0/tinest-cli-macos-arm64.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/tinyrack-net/coder/releases/download/v0.7.0/tinest-cli-linux-x64.tar.gz"
